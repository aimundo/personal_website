...
But let me say this: it's doable, and that is the beauty of the Hugo Apero theme, it is very well organized and makes it easy to follow!

### How the idea started

A couple weeks ago I read a Tweet from Alison Presmanes Hill where se commented on the beauty of Deisy Gysi's [site](https://deisygysi.github.io/). And the site is truly beautiful, the background is mesmerizing! I was intrigued on how this could be done. 

Because I am no programming wizard (faaaar from it), but have learned to dig information during my PhD, I decided to start my quest by googling "hugo background animation". Among the first results that I could see, there was one that caught my eye: "Customizing a Hugo theme with an animated P5.js background" (which can be found [here](https://nathan.exchange/posts/p5js-background-for-hugo/)). 
...
First, we need to call the p5.js library:
...
Ok, so here is where things get interesting. It took some reading to understand that 
